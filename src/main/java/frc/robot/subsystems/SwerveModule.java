...
public class SwerveModule {
  ...
  // TODO: Adjust gains
  private final SimpleMotorFeedforward m_driveFeedforward = new SimpleMotorFeedforward(0, 0/*0.015, 0.285*/);
  ...
  public void goToZero(double encZero){
    // Calculate the turning motor output from the turning PID controller.
    final double turnOutput =
        m_turningPIDController.calculate(getSteerEncPosition(), encZero);
